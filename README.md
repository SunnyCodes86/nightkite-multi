...
Die neuen Audio-Patterns sind `audio_pulse_angle_color` (23), `audio_spectrum_ribbon` (24), `audio_beat_ripples` (25), `audio_band_comets` (26) und `audio_beat_mosaic` (27). Energy und Frequenzbaender bestimmen Helligkeit, Form und Akzente; Beat, BeatMs und Phase halten die Bewegung synchron. Yaw, Pitch oder lokale Bewegung beeinflussen weiterhin die Farbe. Bei V1 oder wenn laenger als 500 ms kein neues gueltiges V2-Audioframe empfangen wurde, werden alle fuenf Patterns schwarz und ihre Audiohistorie wird zurueckgesetzt. Es gibt keinen lokalen oder synthetischen Audiofallback. Werkseinstellungen aktivieren alle 27 Patterns. Config-Version 401 aktiviert die neuen IDs einmalig auch in aelteren gespeicherten Pattern-Masks; Config-Version 402 ergaenzt den persistenten Show-Control-Empfang, der bei Migration aus 400/401 standardmaessig aus bleibt.
